...
import roger.app.address.view.BirthdayStatisticsController;
...
public class Main extends Application {
    ...
    public void showBirthdayStatistics() {
        try {
            //load the fxml fie and create a new stage for the popup
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(new URL("file:///home/roger/IdeaProjects/AddressAppJavaFx/src/roger/app/address/view/BirthdayStatistics.fxml"));
